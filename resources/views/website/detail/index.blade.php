                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category">
                                <i class="lni lni-tag"></i> Sub Category Name:
                                <a href="javascript:void(0)">{{ $product->subCategory->name }}</a>
                            </p>
                            <p class="category">
                                <i class="lni lni-tag"></i> Brand Name:
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group quantity">
                                            ...
                                            <input type="number" name="qty" class="form-control" min="1" value="1" placeholder="Enter Quantity">
                                        </div>
                                    </div>
                                </div>
